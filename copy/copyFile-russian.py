...
#根据本地实际情况，修改下列参数。
pc_diff_path = r"H:\russian\diff\client\pc"
android_diff_path = r"H:\russian\diff\client\android"
ios_diff_path = r"H:\russian\diff\client\ios"
base_target_path = r"H:\russian\client\AllRes\chs\fullRes"
